      ...
      <section className="bg-gradient-to-t from-black to-gray-900 h-full rounded-xl w-full p-5 py-7">
        <div className="text-center md:text-left md:px-16">
          <h2 className="text-gray-300">
            Bienvenido de vuelta,<span className="font-bold"> {info.veterinario.nombre}!!</span>
          </h2>
        ...
        <div className="mt-10 grid md:grid-cols-2 gap-2">
          <article className="rounded-[10px] bg-card p-5 max-h-[200px] md:h-[180px]">
            ...
            <div>
              <p className="text-[2.5rem] text-center text-blue-500">{trabajadores.VETERINARIOS.cantidad}</p>
            </div>
          </article>
          ...
          <article className="rounded-[10px] bg-card p-5 max-h-[200px] md:h-[180px]">
            ...
            <div>
              <p className="text-[2.5rem] text-center text-blue-500">{trabajadores.AUXILIARES.cantidad}</p>
            </div>
          </article>
          ...
          <article className="rounded-[10px] bg-card p-5 max-h-[200px] md:h-[180px]">
            ...
            <div>
              <p className="text-[2.5rem] text-center text-blue-500">{"15"}</p>
            </div>
          </article>
