...
const Nav = () => {
  ...
  return (
    <nav className={`${
      ...
      <div className="py-5 px-2 flex flex-col gap-2 mt-[8rem] md:mt-[0px]">
        <Link to={"/admin-dashboard/configuracion"} className={`flex items-center justify-center ${modoOscuro ? "bg-stone-900 hover:bg-stone-950" : "bg-blue-600 hover:bg-blue-700"}  rounded-[10px] py-2 px-2 text-[1.3rem] text-white  transition`}>
