    ...
    <div className="bg-black rounded-md  hover:shadow-sm hover:shadow-blue-800 hover:translate-y-[-3px] transition-all">
      <div className="px-4 py-2  flex gap-5 transition-all items-center justify-between ">
        ...
        <div className=" md:mr-[70%] flex flex-col gap-[3px]">
          ...
          <p className="text-zinc-100 md:text-[11px] text-[9px] flex items-center gap-2">
            <svg
              className="text-lg"
          ...
          <p className="text-zinc-100 md:text-[11px] text-[9px] flex items-center gap-2">
            ...
            >
              <path
                fill="#4063ff"
                d="m19.5 15.5l-1.425-1.4l1.1-1.1H16v-2h3.15l-1.075-1.075L19.5 8.5L23 12zM2 5V3h12v2zm4.5 12.5h3V15H12v-3H9.5V9.5h-3V12H4v3h2.5zM1 21V6h14v15z"
              />
            </svg>
            Paciente: {nombrePaciente()}
          </p>
          <p className="text-zinc-400 md:text-[11px] font-semibold text-[9px] flex  gap-2">
            <svg
              className="text-lg"
              xmlns="http://www.w3.org/2000/svg"
              width="1em"
