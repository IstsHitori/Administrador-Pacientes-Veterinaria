    ...
    >
      ...
      <ul className="py-5 px-2 flex flex-col gap-8 md:gap-2 ">
        <li className="relative transition-all group">
          ...
          <Link
            to={"/auxiliar-dashboard"}
            className={linkClass("/auxiliar-dashboard")}
          >
        ...
        <li className="relative transition-all group">
          ...
          <Link
            to={"/auxiliar-dashboard/pacientes"}
            className={linkClass("/auxiliar-dashboard/pacientes")}
          >
        ...
        <li className="relative transition-all group">
          ...
          <Link
            to={"/auxiliar-dashboard/agregar-pacientes"}
            className={linkClass("/auxiliar-dashboard/agregar-pacientes")}
          >
        ...
        <li className="relative transition-all group">
          ...
          <Link
            to={"/auxiliar-dashboard/historias"}
            className={linkClass("/auxiliar-dashboard/historias")}
          >
      ...
      <div className="py-5 px-2 flex flex-col gap-2 absolute bottom-5 md:mt-[1rem]">
        <Link
          to={"/auxiliar-dashboard/configuracion"}
